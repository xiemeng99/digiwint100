 ...
 */
public class SuitPickingHalfLogic extends CommonLogic {

    public static SuitPickingHalfLogic logic;

    private SuitPickingHalfLogic(Context context, String module, String timestamp) {
        super(context, module, timestamp);
    }

    public static SuitPickingHalfLogic getInstance(Context context, String module, String timestamp) {

        return logic = new SuitPickingHalfLogic(context, module, timestamp);
    }
