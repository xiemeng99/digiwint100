...
public class OrderPutawaySumAdapter extends BaseRecyclerAdapter<ListSumBean> {


    public OrderPutawaySumAdapter(Context ctx, List<ListSumBean> list) {
        super(ctx, list);
    }

    @Override
    protected int getItemLayout(int viewType) {
        return R.layout.ryitem_orderputaway_sum;
    }
