...
public class ZPutInStoreSumAdapter extends BaseRecyclerAdapter<ListSumBean> {

    public ZPutInStoreSumAdapter(Context ctx, List<ListSumBean> list) {
        super(ctx, list);
    }

    @Override
    protected int getItemLayout(int viewType) {
        return R.layout.ryitem_zput_instore_sum;
    }
