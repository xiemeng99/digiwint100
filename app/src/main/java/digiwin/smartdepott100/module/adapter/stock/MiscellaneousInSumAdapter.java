...
public class MiscellaneousInSumAdapter extends BaseRecyclerAdapter<ListSumBean> {
    ...
    protected void bindData(RecyclerViewHolder holder, int position, final ListSumBean item) {
        ...
        if (numb2 == 0) {
            ...
            holder.setTextColor(R.id.tv_signcode, a.getColor(0,mContext.getResources().getColor(R.color.Base_color)));
            ...
            holder.setTextColor(R.id.tv_signcode, a.getColor(1,mContext.getResources().getColor(R.color.outside_yellow)));
            ...
            holder.setTextColor(R.id.tv_signcode, a.getColor(2,mContext.getResources().getColor(R.color.green1b)));
