...
import digiwin.smartdepott100.module.fragment.stock.miscellaneous.nocomeout.MiscellaneousNocomeOutScanFg;
import digiwin.smartdepott100.module.fragment.stock.miscellaneous.nocomeout.MiscellaneousNocomeOutSumFg;
...
public class MiscellaneousNocomeOutActivity extends BaseFirstModuldeActivity {
    /**
     * 标题
     */
     ...
     * 扫码
     */
    public MiscellaneousNocomeOutScanFg scanFg;
    /**
     * 汇总提交
     */
    MiscellaneousNocomeOutSumFg sumFg;
    ...
    public String moduleCode() {
        module = ModuleCode.MISCELLANEOUSNOCOMEOUT;
        return module;
    }
...
//    }
    ...
    protected void initNavigationTitle() {
        ...
        mName.setText(R.string.miscellaneous_nocome_out);
...
//        iv_un_com.setVisibility(View.VISIBLE);
    ...
    private void initFragment() {
        ...
        scanFg = new MiscellaneousNocomeOutScanFg();
        sumFg = new MiscellaneousNocomeOutSumFg();
