 ...
 * @author xiemeng
 * @des 供应商平台扫码收货
 * @date 2017/6/12 20:15
 */

public class PurchaseSupplierActivity extends BaseFirstModuldeActivity {
    /**
     * 标题
     */
...
//    }
     ...
     * 扫码
     */
    public PurChaseSupplierScanFg scanFg;
    /**
     * 汇总提交
     */
    public PurChaseSupplierSumFg sumFg;
    ...
    protected void initNavigationTitle() {
        ...
        mName.setText(R.string.purchase_scan_supplier);
        //iv_un_com.setVisibility(View.VISIBLE);
    }

    @Override
    protected int bindLayoutId() {
        return R.layout.activity_purchase_supplier;
    }
    ...
    private void initFragment() {
        scanFg = new PurChaseSupplierScanFg();
        sumFg = new PurChaseSupplierSumFg();
