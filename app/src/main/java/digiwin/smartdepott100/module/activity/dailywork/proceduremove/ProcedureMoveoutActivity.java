 ...
 * @author xiemeng
 * @des  工序转移出
 * @date 2017/5/21 09:36
 */

public class ProcedureMoveoutActivity extends BaseTitleActivity{
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case CIRCULATIONWHAT:
                    ...
                    circulationMap.put(AddressContants.MOVE_STATUS, AddressContants.MOVEOUT);
                    ...
                    break;
                case PROCEDUREWHAT:
                    final HashMap<String, String> procedureMap = new HashMap<>();
                    ...
                    procedureMap.put(AddressContants.MOVE_STATUS, AddressContants.MOVEOUT);
    ...
    protected int bindLayoutId() {
        return R.layout.activity_procedure_moveout;
    }

    @Override
    protected void initNavigationTitle() {
        super.initNavigationTitle();
        mName.setText(R.string.procedure_moveout);
    }
...
//        }
        ...
        try {
            ...
            procedureMoveLogic.commitMoveout(commitBean, new ProcedureMoveLogic.CommitListListener() {
                @Override
