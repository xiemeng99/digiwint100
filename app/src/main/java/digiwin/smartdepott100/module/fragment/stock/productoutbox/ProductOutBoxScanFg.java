...
public class ProductOutBoxScanFg extends BaseFragment {
    ...
    void save() {
        ...
        commonLogic.saveBean(saveBean, new ProductOutBoxLogic.SaveBinningListener() {
            @Override
    ...
    ProductOutBoxLogic commonLogic;
    ...
    private void initData() {
        ...
        commonLogic = ProductOutBoxLogic.getInstance(context, pactivity.module, pactivity.mTimestamp.toString());
        barcodeShow = "";
