...
public class SuitPickingHalfSumFg extends BaseFragment {
    ...
    protected int bindLayoutId() {
        return R.layout.fg_suitpickinghalf_sum;
    }
    ...
    private void getDetail(final ListSumBean orderSumData) {
        ...
        suitPickingHalfLogic.getDetail(map, new CommonLogic.GetDetailListener() {
            @Override
    ...
    private void sureCommit() {
        ...
        suitPickingHalfLogic.commit(map, new CommonLogic.CommitListener() {
            @Override
