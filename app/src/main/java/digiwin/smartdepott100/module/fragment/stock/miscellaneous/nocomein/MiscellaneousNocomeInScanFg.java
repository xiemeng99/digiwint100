 ...
 * @des 杂项收料 扫码页面
 */
public class MiscellaneousNocomeInScanFg extends BaseFragment {
    ...
    public void initData() {
        ...
        commonLogic = MiscellaneousNocomeInLogic.getInstance(context, pactivity.module, pactivity.mTimestamp.toString());
        }
