...
# in E:\android\android_studio2.2\androidstudio_sdk2.2/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class digiwin.smartdepot.litepal.** { *; }
-keep class digiwin.smartdepot.login.bean** { *; }
-keep class digiwin.smartdepot.main.bean** { *; }
-keep class digiwin.smartdepot.module.bean.** { *; }

-keep class digiwin.library.xml.** { *; }

#-keep class digiwin.pulltorefreshlibrary.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class digiwin.smartdepot.R$*{
    public static final int *;
}
-keep public class digiwin.library.R$*{
    public static final int *;
}
-keep public class digiwin.pulltorefreshlibrary.R$*{
    public static final int *;
}
-keepclassmembers class * {
...
-keep enum com.thoughtworks.xstream.** { *; }
-keepattributes Annotation

#com.polite.android
-dontwarn com.polites.android.**
-keep class com.polites.android.** { *; }
-keep enum com.polites.android.** { *; }
